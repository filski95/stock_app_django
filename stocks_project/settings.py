...
SECRET_KEY = "django-insecure-h)lqy9q)uv1#8h*d!5(942bw&9mh2j-z&_8r_y%s36%4s_(fqo"
...
REST_FRAMEWORK = {
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.IsAuthenticated",  # user has to be logged in to access API
    ],
